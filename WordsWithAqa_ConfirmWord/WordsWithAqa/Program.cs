    ...
    class Paper1Alevel2018CS
    {
        ...
        private static string GetChoice()
        {
            ...
            do
            {
                ...
                if(MenuChoice.Contains(Choice))
                {
                    return Choice;
                }
                else
                {
                    Console.Write("Are you sure this is your word? (y/n): ");
                    ConfirmWord = Console.ReadLine();
                    Console.WriteLine();
                }
            } while (!MenuChoice.Contains(Choice) || ConfirmWord == "n");
