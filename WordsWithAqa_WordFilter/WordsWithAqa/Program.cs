...
namespace WordsWithAqa
{
    class Paper1Alevel2018CS
    {
        ...
        {
            List<string> FilteredWords = new List<string>{ "AAA", "MOISTURE", "MTV", "NVIDIA", "OBESITY", "PICK" };
            string Choice;
            ...
            do
            {
                ...
                {
                    Console.WriteLine("Word not allowed. New word: ");
                }
            } while (FilteredWords.Contains(Choice));
