...
namespace WordsWithAqa
{
    class Paper1Alevel2018CS
    {
        ...
        class Player
        {
            string PlayerTiles{get; set;}
            int Score { get; set; }
            int NoOfTilesPlayed { get; set; }

            public Player(QueueOfTiles TileQueue)
            {
                PlayerTiles = "";
                Score = 50;
                NoOfTilesPlayed = 0;
        ...
        {
            Console.WriteLine("Press 1 for default dictionary");
            Console.WriteLine("Press 2 for custom dictionary");
            ...
            while (!ValidChoice)
            {
                ...
                else
                {
                    ...
                    if (ValidWord)
                    {
                        ...
                        {
                            Console.WriteLine();
                            Console.WriteLine("Valid word. {0} scores {1} points", Choice, GetScoreForWord(Choice, TileDictionary));
                            Console.WriteLine();
