...
namespace WordsWithAqa
{
    class Paper1Alevel2018CS
    {
        ...
        private static void AddEndOfTurnTiles(ref QueueOfTiles TileQueue, ref string PlayerTiles,
        ...
        private static void UpdateAfterAllowedWord(string Word, ref string PlayerTiles,
            ref int PlayerScore, ref int PlayerTilesPlayed, Dictionary<char, int> TileDictionary,
        ...
        private static void UpdateScoreWithPenalty(ref int PlayerScore, string PlayerTiles,
        ...
        private static void HaveTurn(string PlayerName, ref string PlayerTiles,
            ref int PlayerTilesPlayed, ref int PlayerScore, Dictionary<char, int> TileDictionary,
            ref QueueOfTiles TileQueue, List<string> AllowedWords, int MaxHandSize, int NoOfEndOfTurnTiles)
        {
            Console.WriteLine();
                ...
                else
                {
                    ...
                    if (ValidWord)
                    {
                        ...
                        if (ValidWord)
                        {
                            ...
                            Console.WriteLine();
                            UpdateAfterAllowedWord(Choice, ref PlayerTiles, ref PlayerScore,
                                ref PlayerTilesPlayed, TileDictionary, AllowedWords);
