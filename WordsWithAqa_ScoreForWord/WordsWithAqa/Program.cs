...
namespace WordsWithAqa
{
    class Paper1Alevel2018CS
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (Choice != "9")
            {
                ...
                else if (Choice == "3")
                {
                    ...
                    AllowedWords.Add(newWord);
                    Console.Write("{0} added to allowed words", newWord);
                }
            }
        }
        ...
        private static string GetChoice()
        {
            ...
            Console.WriteLine("     press 2 to get score for a word OR");
            Console.WriteLine("     press 3 to skip turn OR");
        ...
        private static void HaveTurn(string PlayerName, ref string PlayerTiles, ref int PlayerTilesPlayed, ref int PlayerScore, Dictionary<char, int> TileDictionary, ref QueueOfTiles TileQueue, List<string> AllowedWords, int MaxHandSize, int NoOfEndOfTurnTiles)
        {
            ...
            while (!ValidChoice)
            {
                ...
                else if (Choice == "2")
                {
                    ...
                    int score = GetScoreForWord(word.ToUpper(), TileDictionary);
                    Console.WriteLine("Score for {0} would be: {1}", word, score);
                }
                else if (Choice == "3")
                {
                    ValidChoice = true;
                    ...
                    do
                    {
                        Console.Write("How many tiles to draw: ");
