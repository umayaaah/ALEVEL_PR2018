...
namespace WordsWithAqa
{
    class Paper1Alevel2018CS
    {
        ...
        private static string ShuffleTiles(ref string PlayerTiles)
        {
            Random rnd = new Random();
            int randno;
            char temp;
            ...
            {
                randno = rnd.Next(0, PlayerTiles.Length);
                temp = tiles[i];

                tiles[i] = PlayerTiles[randno];
                tiles[randno] = PlayerTiles[temp];
            }

            // Converts char array back into string
            PlayerTiles = new string(tiles);
            return PlayerTiles;
        ...
        private static string GetChoice()
        {
            ...
            Console.WriteLine("     press 2 to shuffle hand OR");
